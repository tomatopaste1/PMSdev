...
if ($esportavaluta and ($cambiavaluta or $cambiaarrotonda or $cambiaarrtasse or $aggvaluta2 or $cambvaluta2 or $elimvaluta2)) {
$esportacatpers = "";
if ($priv_modpers_valute == "t") $id_utente_mod = "tutti";
if ($priv_modpers_valute == "g") $id_utente_mod = "ut_gr";
} # fine if ($esportavaluta and ($cambiavaluta or...
if ($esportacatpers and ($cambianumcatpers or $cambiacatpers)) {
if ($priv_modpers_cat_pers == "t") $id_utente_mod = "tutti";
if ($priv_modpers_cat_pers == "g") $id_utente_mod = "ut_gr";
} # fine if ($esportacatpers and ($cambianumcatpers or $cambiacatpers))
...
} # fine if ($aggvaluta2 or $cambvaluta2)
...
$aggvaluta2_orig = $aggvaluta2;
$nuova_valuta2_orig = $nuova_valuta2;
if ($cambvaluta2) {
$anchor = "utenti_pers";
...
echo mex("Regione/provincia",$pag).":
 ".mostra_lista_relutenti("nuova_regione_strutt",$dati_strut[16],$id_utente,"nome_regione","idregioni","idregione",$tableregioni,$tablerelutenti,"","","","citta","nuovo_comune_strutt","nazione",$id_sup_sel)."
</td><td style=\"width: 50px;\"></td><td>
".mex("Indirizzo",$pag).":
...
".mex("URL del logo",$pag).":
 <input id=\"n_logostr\" type=\"text\"$readonly name=\"nuovo_logo_strutt\" size=\"32\" value=\"".$dati_strut[15]."\">".upload_hd_img_form('n_logostr',$tablepersonalizza)."
</td></tr></table>
