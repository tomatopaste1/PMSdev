...
if ($modpers_cat_pers == "s" or $modpers_cat_pers == "g" or $modpers_cat_pers == "t" or $modpers_cat_pers == "n") $nuovi_priv_mod_pers = substr($nuovi_priv_mod_pers,0,6).$modpers_cat_pers.substr($nuovi_priv_mod_pers,7);
if ($modpers_valute == "s" or $modpers_valute == "g" or $modpers_valute == "t" or $modpers_valute == "n") $nuovi_priv_mod_pers = substr($nuovi_priv_mod_pers,0,7).$modpers_valute.substr($nuovi_priv_mod_pers,8);
if ($crea_pagineweb == "s" or $crea_pagineweb == "c" or $crea_pagineweb == "n") $nuovi_priv_mod_pers = substr($nuovi_priv_mod_pers,0,8).$crea_pagineweb;
...
if (substr($priv_mod_prenota,27,1) != ${"modp_canc_perm".$anno_modifica}) {
...
} # fine if (substr($priv_mod_prenota,27,1) != ${"modp_canc_perm".$anno_modifica})
...
if (${"mod_reg1".$anno_modifica} == "s" and (${"mod_reg1_tipo".$anno_modifica} == "a" or ${"mod_reg1_tipo".$anno_modifica} == "t")) ${"mod_reg1".$anno_modifica} = ${"mod_reg1_tipo".$anno_modifica};
...
if (substr($priv_ins_tariffe,5,1) != ${"mod_reg2".$anno_modifica}) {
...
} # fine if (substr($priv_ins_tariffe,5,1) != ${"mod_reg2".$anno_modifica})
...
if ($modp_comm_pers == "n" or $modp_comm_pers == "s") $nuovi_priv_mod_prenota = substr($nuovi_priv_mod_prenota,0,26).$modp_comm_pers.substr($nuovi_priv_mod_prenota,27);
if ($modp_canc_perm == "n" or $modp_canc_perm == "c" or $modp_canc_perm == "s") $nuovi_priv_mod_prenota = substr($nuovi_priv_mod_prenota,0,27).$modp_canc_perm;
...
if ($mod_reg1 == "n" or $mod_reg1 == "a" or $mod_reg1 == "t" or $mod_reg1 == "s") $nuovi_priv_ins_tariffe = substr($nuovi_priv_ins_tariffe,0,4).$mod_reg1.substr($nuovi_priv_ins_tariffe,5);
if ($mod_reg2 == "n" or $mod_reg2 == "s") $nuovi_priv_ins_tariffe = substr($nuovi_priv_ins_tariffe,0,5).$mod_reg2.substr($nuovi_priv_ins_tariffe,6);
...
<div class=\"tab_cont\"><table style=\"margin-left: auto; margin-right: auto;\" border=\"1\"><tr>$n_costi_agg_imposti";
