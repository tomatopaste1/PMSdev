...
aggiorna_letti_agg_in_periodi($dati_ca,$num_costo,$num_letti_agg,$idinizioperiodo,$idfineperiodo,$settimane_costo_aux,"",$nummoltiplica_ca_aux,$numpersone_corr,$dati_cat_pers,${"catpers_ca".$numca."_".$n_t});
} # fine if ($$costoagg == "SI")
} # fine for $numca
...
else $costi_agg_raggr[$testo_costo."<>".$dati_ca[$num1]['categoria']."<>".(string) $mostra_numpers] .= $dati_ca[$num1]['id'].",";
} # fine if ($attiva_costi_agg_consentiti == "n" or...
} # fine for $num1
...
if (${"nummoltiplica_ca".$numcostiagg."_".$n_t}) {
...
} # fine if (${"nummoltiplica_ca".$numcostiagg."_".$n_t})
...
} # fine if (${$nummoltiplica_ca."_".$n_t})
if (!$mostra_numpers) $testo_costo .= ", ".mex("da moltiplicare per",$pag).":</label>";
