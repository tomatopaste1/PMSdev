...
} # fine if ($cat_persone_copia[$num1])
} # fine for $num1
...
if (strcmp($numpersone_nr[$num1],"")) $numpersone_cp = $numpersone_nr[$num1];
else $numpersone_cp = $numpersone;
...
aggiorna_letti_agg_in_periodi($dati_ca,$numca,$num_letti_agg,$idinizioperiodo,$idfineperiodo,$settimane_costo[$numca],"",$nummoltiplica_ca_aux,$numpersone,$dati_cat_pers,${"catpers_ca".$numca});
...
aggiorna_letti_agg_in_periodi($dati_ca,$numca,$num_letti_agg_nr[$num1],$idinizioperiodo,$idfineperiodo,$settimane_costo[$numca],"",$nummoltiplica_ca_aux,$numpersone_corr,$dati_cat_pers,${"catpers_ca".$numca});
} # fine for $num1
