...
if ($modo['gia_canc']) $dati_prenota = esegui_query("select * from $tableprenotacanc where idprenota = '$id_prenota' and idclienti != '0' ");
...
else esegui_query("insert into $tableprenotacanc select * from $tableprenota where idprenota = '$id_prenota' ");
if ($modo['gia_canc']) esegui_query("delete from $tableprenotacanc where idprenota = '$id_prenota'");
...
elseif (!$modo['gia_canc']) esegui_query("delete from $tableinterconnessioni where idlocale = '$id_prenota' and tipoid = 'prenota' and anno = '$anno' ");
...
$d_prezzo_costo_agg[$numca] = (double) calcola_prezzo_totale_costo($dati_cap,$numca,$d_id_data_inizio,$d_id_data_fine,$dati_cap[$numca]['settimane'],$dati_cap[$numca]['moltiplica_costo'],$d_costo_tariffa,$d_tariffesettimanali,($d_costo_tariffa + $d_costo_agg_tot - $d_sconto),$d_caparra,$d_num_persone,$dati_cap[$numca]['cat_pers'],0,$costo_escludi_perc);
