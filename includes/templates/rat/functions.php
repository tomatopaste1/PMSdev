...
global $apertura_tag_font,$chiusura_tag_font,$stile_tabella_tariffe,$m_valuta_sing,$m_valuta_plur,$prima_parte_html,$ultima_parte_html,$file_css_frame,$tema_modello,$id_transazione;
$tablenometariffe_modello = $PHPR_TAB_PRE."ntariffe".$anno_modello;
