...
global $file_css_frame,$apri_nuova_finestra_da_frame,$altezza_finestra_da_frame,$larghezza_finestra_da_frame,$tema_modello,$num_codici_promo,$parola_settimane,$id_transazione,$id_utente,$lingua_mex;
$tablenometariffe_modello = $PHPR_TAB_PRE."ntariffe".$anno_modello;
...
if (${"attiva_costo".$dati_ca[$numca]['id']} == "SI") $costi_attivati .= " ".$dati_ca[$numca]['id']." => \"$SI\",";
$nome_costo_imposto = "nome_costo_imposto".$dati_ca[$numca]['id'];
...
if (strtoupper($metodi_pagamento_da_chiedere_tr[$met_paga_compara]) == $SI) $metodi_pagamenti_chiesti[$met_paga_compara] = 1;
...
if ($metodi_pagamento_da_chiedere_tr['array_esistente']) {
...
} # fine if ($metodi_pagamento_da_chiedere_tr['array_esistente'])
