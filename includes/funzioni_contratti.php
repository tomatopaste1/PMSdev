...
$regione_struttura = $nome_struttura[16];
...
if (strstr($num_pren_esist[$num1],"+")) {
$num_pren_esist2 = explode("+",$num_pren_esist[$num1]);
if ((($num_pren_esist2[0] + 1) == $anno or ($num_pren_esist2[0] + 1) == $anno_corr) and $num_pren_esist2[2]) $num_pren_esist[$num1] = $num_pren_esist2[2];
else {
...
else $condizione_rip_d_vett[$num1] = "";
} # fine for $num1
...
if ($var_if) {
$cliente = esegui_query("select idclienti from $tableclienti where (email = '".aggslashdb($var_if)."' or email2 = '".aggslashdb($var_if)."') and cognome = '".aggslashdb(${"cognome_".$n_r})."' and doc_inviati $ILIKE '%#@?".aggslashdb($oggetto_email)."#@?%' ");
