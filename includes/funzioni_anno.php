...
global $lingua_mex,$LIKE,$ILIKE,$PHPR_DB_TYPE,$PHPR_DB_NAME;
...
if (!$prefissi_contr[$dir_salva."/".$nome_contratto]) {
...
if (($num4 - 1) == $num_pren_esist2[0]) $n_lista_pren .= "_".$nuovo_idprenota[($num4 - 1)];
else $n_lista_pren .= "-".$nuovo_idprenota[$num4];
} # fine if ($num4 > $num_pren_esist2[0])
$n_lista_pren .= "_$anno_prec+$num4";
if ($nuovo_idprenota_iniziata[$num4]) $n_lista_pren .= "+".$nuovo_idprenota_iniziata[$num4];
...
} # fine else if (!$nuovo_idprenota[$num4])
} # fine for $num4
} # fine else if (strstr($num_pren_esist[$num3],"+"))
} # fine for $num3
$n_nome_contr = $nome_contratto.substr($resto_nome_contr,0,(6 + strlen($num_prog_contr))).$n_lista_pren.".$suff_file";
...
closedir($contr_dir);
} # fine if (!$prefissi_contr[$dir_salva."/".$nome_contratto])
} # fine for $num2
