...
$n_email2 = htmlspecialchars($n_email2);
$n_email_cert = htmlspecialchars($n_email_cert);
...
$d_email2 = htmlspecialchars($d_email2);
$d_email_cert = htmlspecialchars($d_email_cert);
...
if ($c_email2) echo mex("La <b>seconda email</b> verrà cancellata",$pag).".<br>";
if ($c_email_cert) echo mex("L'<b>email certificata (PEC) o il codice destinatario</b> verrà cancellato",$pag).".<br>";
...
<input type=\"hidden\" name=\"c_email2\" value=\"$c_email2\">
<input type=\"hidden\" name=\"c_email_cert\" value=\"$c_email_cert\">
